...
if __name__ == "__main__":
    ...
    K_P = np.array([260e-7, 180e-7, 180e-5, 24e-3]) #np.array([5e-5, 19e-6, 29e-4, 3e-2])
    K_I = np.array([90e-8, 100e-8, 180e-5, 500e-4]) #np.array([9e-6, 90e-7, 40e-4, 55e-3])
    K_D = np.array([40e-10, 190e-10, 170e-7, 35e-5]) #np.array([4e-8, 21e-9, 29e-7, 16e-4])
    ...
    cut1_via = [-165, 15, 270, 15]
    cut1 = [-165, 70, 270, -15]
    cut1_post = [-165, 70, 270, 30]
    cut2_via = [-150, 15, 270, 15]
    cut2 = [-150, 70, 270, -15]
    cut2_post = [-150, 70, 270, 15]
    cut3_via = [-134, 15, 270, 30]
    cut3 = [-135, 70, 270, -15]
    cut3_post = [-135, 70, 270, 30]
