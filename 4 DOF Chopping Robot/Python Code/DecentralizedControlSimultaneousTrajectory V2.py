...
if __name__ == "__main__":
    ...
    K_P = np.array([5e-5, 20e-6, 25e-4, 3e-2]) #np.array([5e-5, 1.5e-5, 2e-3, 3e-2])
    K_I = np.array([9e-6, 9e-6, 50e-4, 55e-3]) #np.array([9e-6, 9e-6, 5e-3, 5e-2])
    K_D = np.array([4e-8, 20e-9, 25e-7, 15e-4]) #np.array([4e-8, 1e-8, 2e-6, 9e-4])
